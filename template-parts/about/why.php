...
<section class="relative bg-cream px-5 md:px-8 py-20 md:py-28 overflow-hidden">
	<div class="relative max-w-6xl mx-auto">
		...
		<h2 class="yum2-reveal text-forest mb-12" style="font-family:'Newsreader',serif;font-size:clamp(32px,5vw,56px);line-height:1.05;letter-spacing:-0.02em;font-weight:400;text-wrap:balance;transition-delay:0.08s;">
		...
		<div class="grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-10 md:gap-16 items-start">
			...
			<div class="yum2-reveal relative mx-auto md:ml-auto w-full max-w-[360px] order-1 md:order-2" style="transition-delay:0.12s;">
