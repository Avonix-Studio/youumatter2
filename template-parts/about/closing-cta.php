...
<section class="relative bg-cream px-5 md:px-8 py-20 md:py-28 overflow-hidden">
	<div class="relative max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[1.15fr_1fr] gap-10 md:gap-16 items-start">
		...
		<div>
			...
			<p class="yum2-reveal italic text-[#3d4f3e] max-w-md mb-8" style="font-family:'Newsreader',serif;font-size:19px;line-height:1.55;transition-delay:0.18s;">
			...
			<div class="yum2-reveal flex flex-wrap items-center gap-3 mb-6" style="transition-delay:0.28s;">
				<?php
				get_template_part(
		...
		<aside class="yum2-reveal relative bg-[#f8f3e9] border border-forest/15 rounded-[22px] p-6 md:p-7 shadow-[0_24px_60px_-30px_rgba(26,58,25,0.25)]" style="transition-delay:0.22s;">
