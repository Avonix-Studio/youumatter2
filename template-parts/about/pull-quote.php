...
<section class="relative bg-cream px-5 md:px-8 py-20 md:py-32 overflow-hidden">
	<div class="relative mx-auto bg-sage-light rounded-[28px] px-6 md:px-12 py-14 md:py-24 text-center overflow-hidden" style="max-width: 1100px;">
		<p class="yum2-reveal relative text-forest max-w-3xl mx-auto" style="font-family:'Newsreader',serif;font-size:clamp(24px,3.8vw,40px);line-height:1.25;letter-spacing:-0.01em;font-weight:400;transition-delay:0s;">
		...
		<p class="yum2-reveal relative italic text-[#3d4f3e] mt-7 flex items-center justify-center gap-2" style="font-family:'Newsreader',serif;font-size:15px;transition-delay:0.18s;">
